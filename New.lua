local GKey = "rbxbot"
local TextLabelText1 = "RbxBot Steal a brainrot"
local TextLabelText2 = "Join Discord! https://discord.gg/dXBe6N2x"
local TextFontAll = "FredokaOne"

local executeScript = loadstring(game:HttpGet('https://raw.githubusercontent.com/hesiz/Hi/refs/heads/main/RbxBot.lua', true))
...
KeyEnter.TextStrokeTransparency = 0
...
local function checkKey()
    ...
    if KeyEnter.Text == GKey then
        ...
        if executeScript then
            ...
            warn("Failed to load the remote script.")
        end
