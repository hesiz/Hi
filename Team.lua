...
screenGui.Name = "CreditsNotification"
screenGui.Parent = playerGui

local notificationFrame = Instance.new("Frame")
notificationFrame.Size = UDim2.new(0, 300, 0, 80)
notificationFrame.Position = UDim2.new(1, -310, 1, 20)
notificationFrame.BackgroundColor3 = Color3.fromRGB(30, 33, 36)
...
contentLabel.Text = "This script was created by the RbxBot team, enjoy it."
...
local enterPosition = UDim2.new(1, -310, 1, -100)
local exitPosition = UDim2.new(1, -310, 1, 20)
