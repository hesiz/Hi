...
titleLabel.TextColor3 = Color3.fromRGB(255, 99, 71)
...
contentLabel.Text = "We hope you enjoyed our script :)."
...
local enterPosition = UDim2.new(1, -290, 1, -100)
