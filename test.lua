...
spawn(function()
    ...
    pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/hesiz/Hi/refs/heads/main/Team.lua"))()
    end)
end)
...
joinDiscordBtn.MouseButton1Click:Connect(function()
    ...
    spawn(function()
        ...
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/hesiz/Hi/refs/heads/main/notificacion.lua"))()
        end)
    end)
